...
// ====================【已修正為 gemini-2.5-flash】====================
async function submitToGemini() {
    const preview = document.getElementById('photo-preview');
    const resultBox = document.getElementById('ai-result-box');
   
    resultBox.style.display = 'block';
    resultBox.innerHTML = `<div style="text-align:center;"><div class="loading-spinner"></div><br>⏳ AI 正在分析照片...</div>`;
    ...
    const requestData = {
        contents: [{
            parts: [
                { text: "這是一張長者口腔照片，請用溫暖親切的語氣，用繁體中文詳細分析清潔度、問題區域，並給予實用改善建議。" },
